...
- **NPM Provenance & Trusted Publishing**: Added `repository` metadata field to `package.json` to satisfy Sigstore provenance verification requirements in GitHub Actions NPM OIDC publishing workflow.
